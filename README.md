...
*Note src code for the UI apps are ommitted due to proprietary reasons. I did include some POC Swift scripts I wrote for the proposals before the full UI App inception.
